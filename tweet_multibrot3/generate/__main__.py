...
from tweet_multibrot3.generate.get_ppm import get_raw_grayscale_image, get_ppm
from tweet_multibrot3.generate.save_img import save_img
from tweet_multibrot3.generate.write_metadata import write_metadata
...
def get_random_range():
    ...
    ## The captured one
    frame_width = total_width/random.randint(1, 1)
...
def main():
    ...
    w, h = 1280, 720  # Note: FHD takes so long to compute
